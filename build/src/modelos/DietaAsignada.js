...
const userSchema = new mongoose_1.default.Schema({
    idUserTrainer: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Trainer', required: true },
    idUserPaciente: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Paciente', required: true },
...
exports.default = mongoose_1.default.model('DietaAsignada', userSchema);
